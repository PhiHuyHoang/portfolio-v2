...
class About extends React.Component {
    ...
    <p>For the front-end, I usually work with Javascript, either standalone or including popular frameworks like ReactJS and VueJS. 
    ...
    Android application with <span class="highlight-text">Java, Kotlin</span>
    or <span class="highlight-text">React Native.</span>
    </p>
